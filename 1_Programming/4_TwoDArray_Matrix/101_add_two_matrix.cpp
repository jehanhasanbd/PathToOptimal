...
int** addTwoMatrix(int row, int col, int** matrix1, int** matrix2) {
...
int main() {
    ...
    int** addMatrix = addTwoMatrix(row, col, matrix1, matrix2);
    printMatrix(row, col, addMatrix);

    freeMatrix(row, matrix1);
    freeMatrix(row, matrix2);
    freeMatrix(row, addMatrix);
}
